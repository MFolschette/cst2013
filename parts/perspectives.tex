...
\todo{Revoir !!!!
\begin{itemize}
  \item Priorités multiples avec précédence (données chronométriques ?)
  \item Traduction CIF2PH (Carito) (projet étudiant ?)
  \item Multiplexes avec délais (Morgan) (données chronométriques !)
\end{itemize}
Ci-dessous la version 2011/2012 de ce chapitre :}
